...
The target response variable is simulated via $\mathcal{N}(\mu_t, 1)$, with $mu_t = \beta_0 + \beta_{pri} + \beta_{comp} + \beta_{rel} + \beta_{trigger} + interactions$. The coefficients for interactions and the trigger effect are assumed to be 0. 
