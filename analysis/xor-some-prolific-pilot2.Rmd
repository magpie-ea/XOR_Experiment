...
Plot inference strength ratings against raw predictor ratings for each participant / each item:
```{r}
d_critical_wide %>%
...
In summary, the different models provide somewhat different results, specially when using raw ratings vs. binary predictors. Since interpreting the categorical models in relation to the plots might be not as straight-forward, I am not entirely sure whether the qualitative results match in all models. Using centered data seems to provide a little tighter estimates in the models; not sure where the slight qualitative differences come from. 