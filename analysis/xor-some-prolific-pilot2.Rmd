...
Plot inference strength ratings against predictor ratings, by-item, using by-item mean ratings across participants. Error bard indicate the standard deviation:
...
#### Smaller models with raw data to check for colinearity 
...
In summary, the different models provide somewhat different results, specially when using raw ratings vs. binary predictors. 