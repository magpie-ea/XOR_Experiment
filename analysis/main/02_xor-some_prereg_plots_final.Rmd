...
left_join(d_critical_predictorsXtarget_summary, d_critical_prior_classes, by = c("title", "predictors" = "class_condition")) %>%
  mutate(prior_class = factor(prior_class, levels = c(0,1), labels=c("low", "high"))) %>%
  ...
  scale_fill_discrete(name = "Prior classification of item") +
  theme(strip.text.y = element_text(size = 8))

ggsave("../../writing/ELM2/byItem-ratings.pdf", width = 9, height = 6)
```
