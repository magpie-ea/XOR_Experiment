...
Perform an alternative exclusion based on comprehension question EXCLUDING the test_false1 question from the vignette with the ID=64 which had an incorrect prior classification.
```{r}
# get participants failing comprehension questions
...
## no idea why it didn't work with just pivot_wider(names_from = block_extended, values_from = response_centered, names_repair = "unique")
